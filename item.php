      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
              <a class="nav-link" href="shop.html">Área do Cliente</a>
            </li>
            <li class="nav-item">
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-lg-12">
          ...
          <div class="card mt-4">
            <img class="card-img-top img-fluid" src="images/produtos/dw268.jpg" alt="">
            <div class="card-body">
              <h3 class="card-title">Parafusadeira DW268 DeWalt</h3>
              <h4>R$ 800,00</h4>
              <p class="card-text">CARACTERÍSTICAS</br>
                • Motor de alta potência para aplicações em metal.</br>
                • Sistema de regulação Versa-embreagem para marcar o torque adequado e de parafuso de fixação de forma eficiente, sem quebrar ou danificar fixadores.</br>
                • Cabo de borracha e gatilho de dois dedos para o conforto.</br>
                • Excelente ergonomia.</p>
