...
<html lang="en">
    ...
    <body>
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto">
                        <li class="nav-item active">
                            <a class="nav-link" href="#">Área do Fornecedor
        ...
        <form action="" method="get" class="container form-horizontal">
            ...
            <div class="form-group">
                ...
                <input class="form-control" type="text" name="estoque" value="">
            </div>

            <div class="form-group">
                <label for="categoria">Categoria:</label>
                <select name="seleccategoria" required="" class="form-control">
            ...
            <div class="form-group">
                ...
                <input type="file" name="upar" id="upar">
